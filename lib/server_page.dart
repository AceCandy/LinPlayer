...
class _AddServerSheetState extends State<_AddServerSheet> {
  ...
  Future<void> _pickIconFromLibrary() async {
    final pickedUrl = await showModalBottomSheet<String?>(
      ...
      isScrollControlled: true,
      showDragHandle: true,
      builder: (ctx) => _ServerIconLibrarySheet(
...
class _ServerIconLibrarySheetState extends State<_ServerIconLibrarySheet> {
  ...
  Future<void> _openLibraryManager() async {
    await showModalBottomSheet<void>(
      ...
      isScrollControlled: true,
      showDragHandle: true,
      builder: (ctx) => _ServerIconLibraryManagerSheet(appState: widget.appState),
    );
  }
    ...
    return Padding(
      ...
      child: FutureBuilder<ServerIconLibraries>(
        ...
        builder: (context, snapshot) {
          ...
          final dropdownValue =
              validIds.contains(_selectedLibraryId) ? _selectedLibraryId : _allLibrariesId;
          ...
          return Column(
            ...
            children: [
              Row(
                children: [
                  ...
                  IconButton(
                    ...
                    icon: const Icon(Icons.refresh),
                    onPressed: () =>
                        setState(() => _libsFuture = _loadLibraries(refresh: true)),
                  ),
                ],
              ),
              const SizedBox(height: 12),
              ...
              const SizedBox(height: 10),
              if (errorCount > 0 && snapshot.connectionState != ConnectionState.waiting)
                Padding(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      trailing: IconButton(
                        ...
                        onPressed: () =>
                            widget.appState.removeServerIconLibraryUrlAt(index),
                      ),
                    );
                  },
                ),
