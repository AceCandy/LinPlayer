...
/// Raw subtitle track data from ExoPlayer Format objects.
class ExoPlayerSubtitleTrackData {
...
/// Container for raw subtitle track data from Android ExoPlayer.
class NativeSubtitleTrackData {
  NativeSubtitleTrackData({this.exoPlayerTracks});
...
abstract class VideoPlayerInstanceApi {
  ...
  /// Gets the available subtitle tracks for the video.
  NativeSubtitleTrackData getSubtitleTracks();

  /// Selects which subtitle track is chosen for playback from its [groupIndex] and [trackIndex]
  void selectSubtitleTrack(int groupIndex, int trackIndex);
