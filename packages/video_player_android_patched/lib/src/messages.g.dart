...
class ExoPlayerSubtitleTrackData {
  ...
  static ExoPlayerSubtitleTrackData decode(Object result) {
    result as List<Object?>;
    return ExoPlayerSubtitleTrackData(
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! ExoPlayerSubtitleTrackData || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class NativeSubtitleTrackData {
  ...
  static NativeSubtitleTrackData decode(Object result) {
    result as List<Object?>;
    return NativeSubtitleTrackData(
      exoPlayerTracks: (result[0] as List<Object?>?)?.cast<ExoPlayerSubtitleTrackData>(),
    );
  }
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! NativeSubtitleTrackData || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class SubtitleStyleMessage {
  ...
  static SubtitleStyleMessage decode(Object result) {
    result as List<Object?>;
    return SubtitleStyleMessage(
      fontSize: result[0]! as double,
      bottomPadding: result[1]! as double,
  ...
  // ignore: avoid_equals_and_hash_code_on_mutable_classes
  bool operator ==(Object other) {
    if (other is! SubtitleStyleMessage || other.runtimeType != runtimeType) {
      return false;
    }
    if (identical(this, other)) {
      return true;
...
class _PigeonCodec extends StandardMessageCodec {
  ...
  void writeValue(WriteBuffer buffer, Object? value) {
    if (value is int) {
      ...
      buffer.putUint8(134);
      writeValue(buffer, value.encode());
    }    else if (value is ExoPlayerSubtitleTrackData) {
      buffer.putUint8(135);
      writeValue(buffer, value.encode());
    }    else if (value is NativeSubtitleTrackData) {
      buffer.putUint8(136);
      writeValue(buffer, value.encode());
    }    else if (value is SubtitleStyleMessage) {
      buffer.putUint8(137);
      writeValue(buffer, value.encode());
  ...
  Object? readValueOfType(int type, ReadBuffer buffer) {
    switch (type) {
      ...
      case 135: 
        return ExoPlayerSubtitleTrackData.decode(readValue(buffer)!);
      case 136: 
        return NativeSubtitleTrackData.decode(readValue(buffer)!);
      case 137: 
        return SubtitleStyleMessage.decode(readValue(buffer)!);
      case 138: 
...
class VideoPlayerInstanceApi {
  ...
  Future<NativeSubtitleTrackData> getSubtitleTracks() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.getSubtitleTracks$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    ...
    if (pigeonVar_replyList == null) {
      ...
      return (pigeonVar_replyList[0] as NativeSubtitleTrackData?)!;
    }
  }
  ...
  Future<void> selectSubtitleTrack(int groupIndex, int trackIndex) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.selectSubtitleTrack$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> deselectSubtitleTrack() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.deselectSubtitleTrack$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<String> getSubtitleText() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.getSubtitleText$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setSubtitleDelay(int delayMs) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setSubtitleDelay$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> setSubtitleStyle(SubtitleStyleMessage style) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.setSubtitleStyle$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
  ...
  Future<void> addSubtitleSource(String uri, String? mimeType, String? language, String? label) async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.addSubtitleSource$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(
      pigeonVar_channelName,
      pigeonChannelCodec,
      binaryMessenger: pigeonVar_binaryMessenger,
    );
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(<Object?>[uri, mimeType, language, label]);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
    if (pigeonVar_replyList == null) {
      throw _createConnectionError(pigeonVar_channelName);
    } else if (pigeonVar_replyList.length > 1) {
