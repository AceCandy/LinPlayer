 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class ExoPlayerSubtitleTrackData (
  val groupIndex: Long,
  val trackIndex: Long,
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): ExoPlayerSubtitleTrackData {
      ...
      val mimeType = pigeonVar_list[6] as String?
      return ExoPlayerSubtitleTrackData(groupIndex, trackIndex, label, language, isSelected, codec, mimeType)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is ExoPlayerSubtitleTrackData) {
      return false
    }
    if (this === other) {
      return true
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class NativeSubtitleTrackData (
  /** ExoPlayer-based tracks */
  val exoPlayerTracks: List<ExoPlayerSubtitleTrackData>? = null
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): NativeSubtitleTrackData {
      val exoPlayerTracks = pigeonVar_list[0] as List<ExoPlayerSubtitleTrackData>?
      return NativeSubtitleTrackData(exoPlayerTracks)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    if (other !is NativeSubtitleTrackData) {
      return false
    }
    if (this === other) {
      return true
...
private open class MessagesPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      135.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          ExoPlayerSubtitleTrackData.fromList(it)
        }
      }
      136.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          NativeSubtitleTrackData.fromList(it)
        }
      }
      137.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      ...
      is ExoPlayerSubtitleTrackData -> {
        stream.write(135)
        writeValue(stream, value.toList())
      }
      is NativeSubtitleTrackData -> {
        stream.write(136)
        writeValue(stream, value.toList())
      }
...
interface VideoPlayerInstanceApi {
  ...
  fun getSubtitleTracks(): NativeSubtitleTrackData
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: VideoPlayerInstanceApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.getSubtitleTracks$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              listOf(api.getSubtitleTracks())
            } catch (exception: Throwable) {
              MessagesPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.selectSubtitleTrack$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val groupIndexArg = args[0] as Long
            val trackIndexArg = args[1] as Long
            val wrapped: List<Any?> = try {
              api.selectSubtitleTrack(groupIndexArg, trackIndexArg)
              listOf(null)
            } catch (exception: Throwable) {
              MessagesPigeonUtils.wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.video_player_android.VideoPlayerInstanceApi.deselectSubtitleTrack$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
